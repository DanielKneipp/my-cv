...
\header{Daniel}{ Kneipp}{Artificial Intelligence Developer} % Your name and current job title/field
...
\printbibsection{article}{Article in journals} % Print all articles from the bibliography
