...
\entry
    ...
    {Invent Vision}
    {Deep Learning research for Computer Vision applications. Implemented a set of tools to speedup the development (including synthetic dataset generation) and deployment of image classifiers in embedded systems (NVIDIA Jetson).}
